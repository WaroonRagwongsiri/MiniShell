...
/*   Updated: 2025/10/31 16:19:26 by waragwon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av, char **env)
{
	...
	cmd_lines = simple_new_cmd((char *[]) {"/bin/cat", NULL}, env);
	second = simple_new_cmd((char *[]) {"/bin/cat", NULL}, env);
	cmd_lines->next = second;
	second->prev = cmd_lines;
	third = simple_new_cmd((char *[]) {"/bin/cat", NULL}, env);
	second->next = third;
	third->prev = second;
